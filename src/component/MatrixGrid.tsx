    ...
    <div style={{ maxWidth:'920px' }}>
      ...
      <div style={{ margin: '3em auto 9em auto'}}>
        ...
        <p className='guide-text'>
          ...
          かたや取り残された芸術家は純粋数学や哲学理念の美しさを愛でるほどの知能も持ち合わせないまま、美術史に名を残すことを目指す下世話な人々として、興行と資産運用商品製造へと収斂する。<br />
          芸術家は応用数学や哲学の孫引きはできるが、純粋数学や哲学理念の美しさを愛でるほどの知能は未だに持ち合わせない。また政治経済／社会／歴史／哲学宗教の諸学問から逸脱疎外してしまう気質の者だけが居残る分野として、芸術は今日に至る。<br />
        </p>
        <br />
